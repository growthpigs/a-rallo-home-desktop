          ...
          <div className="flex-col max-w-screen-md items-start gap-8 w-full flex relative">
            <div className="flex flex-col items-start gap-4 w-full relative">
              ...
              <div className="flex flex-col items-start gap-6 relative w-full">
                <h2 className="mt-[-1.00px] text-[length:var(--heading-h2-font-size)] leading-[var(--heading-h2-line-height)] relative font-heading-h2 font-[number:var(--heading-h2-font-weight)] text-black tracking-[var(--heading-h2-letter-spacing)] [font-style:var(--heading-h2-font-style)]">
                  AI THAT HEARS WHAT YOU DON&#39;T SAY
                </h2>

                <p className="relative font-text-medium-normal font-[number:var(--text-medium-normal-font-weight)] text-black text-[length:var(--text-medium-normal-font-size)] tracking-[var(--text-medium-normal-letter-spacing)] leading-[var(--text-medium-normal-line-height)] [font-style:var(--text-medium-normal-font-style)]">
            ...
            <div className="inline-flex items-center gap-6 relative">
              ...
              <Button
                variant="ghost"
                className="h-auto inline-flex items-center justify-center gap-2 p-0 hover:bg-transparent font-text-regular-normal font-[number:var(--text-regular-normal-font-weight)] text-black text-[length:var(--text-regular-normal-font-size)] tracking-[var(--text-regular-normal-letter-spacing)] leading-[var(--text-regular-normal-line-height)] [font-style:var(--text-regular-normal-font-style)]"
              >
                Watch Demo
