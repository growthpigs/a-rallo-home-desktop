...
export const PricingHeroSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-20 px-16 pt-40 pb-28 relative self-stretch w-full flex-[0_0_auto] bg-black">
      <div className="flex flex-col max-w-screen-xl items-center gap-20 relative w-full flex-[0_0_auto]">
        <div className="flex flex-col max-w-screen-md items-center gap-8 relative w-full flex-[0_0_auto] mx-auto">
          ...
          <div className="inline-flex gap-4 flex-[0_0_auto] items-center justify-center relative mt-6">
            <Button className="inline-flex items-center justify-center gap-0.5 px-6 py-3 relative flex-[0_0_auto] bg-white border border-solid border-white rounded-lg h-auto font-['JetBrains_Mono'] font-normal uppercase text-black text-sm tracking-[0.2em] transition-all duration-200 hover:bg-gray-100">
              GET STARTED
            </Button>

            <Button
              variant="ghost"
              className="inline-flex items-center justify-center gap-0.5 px-6 py-3 relative flex-[0_0_auto] bg-transparent border border-solid border-white rounded-lg h-auto font-['JetBrains_Mono'] font-normal uppercase text-white text-sm tracking-[0.2em] transition-all duration-200 hover:bg-white hover:text-black"
            >
              BOOK DEMO
            </Button>
          </div>
