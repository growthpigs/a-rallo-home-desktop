...
export const GeneralLayoutSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-20 px-16 py-28 relative self-stretch w-full flex-[0_0_auto] bg-[#000000] pt-[222px] pb-[222px]">
      <div className="flex flex-col max-w-screen-xl items-start gap-0.5 relative w-full flex-[0_0_auto]">
        <div className="flex items-start gap-16 relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col w-[438px] items-start self-stretch relative">
            <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <div className="inline-flex items-center gap-1 relative flex-[0_0_auto] mt-6">
                <Button
                  variant="outline"
                  className="h-auto inline-flex items-center justify-center gap-0.5 px-6 py-3 relative flex-[0_0_auto]  mb-[-1.00px] ml-[-1.00px] mr-[-1.00px] border border-solid border-black hover:bg-black hover:text-white text-[#050505] bg-[#ffffff]"
                >
